...
Start accepting payments on pages or blogs built on SiteOrigin. Offer credit/debit cards, UPI, wallets and more in less than five minutes. List multiple products, or allow customers to choose the amount they want to pay. Donate Now, Buy Now, Subscribe Now, Support Now button and more
== Description ==
...
1. Collect payments faster with pre-made templates. You can add a Donate button on your SiteOrigin built site/blog pages in seconds.
2. Powerful dashboard to help you manage your payments and track real-time data and insights.
3. Collect payments via UPI, credit/debit card, net-banking, wallets and more on your SiteOrigin built site with a single plugin.
...
= 1.0.2 =
* Updated Razorpay PHP SDK to compatible with PHP 8.1
